...
一个简洁美观的 Rainmeter 进度条皮肤，用于在桌面显示日常时间进度和项目截止日期倒计时。这个常驻的可视化小组件，时时刻刻提供具体的每日进度数字，可以对人产生潜移默化的影响，帮助克服拖延、克服短视频沉迷，保持清醒。也可以简单的作为一个下班和放假倒计时。适合长时间在电脑屏幕前办公、学习的用户。
...
DayProgress 皮肤默认会在到达每天的结束时间后隐藏。Deadline 皮肤默认会在到达结束时间后保持显示。可自行更改。
